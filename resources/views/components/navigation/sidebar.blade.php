<!-- 
  CATATAN PENGEMBANG:
  - Logika status aktif telah diperbarui secara signifikan.
  - Sekarang, status aktif ditentukan dengan mencocokkan segmen terakhir (seperti ID atau kode plant) dari URL.
  - Contoh: Jika URL saat ini adalah '.../data2/detail/1001', maka item menu yang mengarah ke '.../dashboard/1001' akan dianggap aktif.
  - Ini memungkinkan menu yang relevan tetap aktif bahkan saat berada di halaman detail yang memiliki rute dasar yang berbeda.
-->
...
<aside 
    ...
    <div class="flex flex-col h-full">
        ...
        <a href="{{ route('dashboard_all') }}"><div class="flex items-center h-16 shrink-0 px-4 border-b border-gray-200" :class="sidebarCollapsed ? 'justify-center' : 'justify-start'">
