                            ...
                            <table class="min-w-full table-auto text-sm text-left whitespace-nowrap border">
                                <thead class="bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300">
                                    <tr>
                                        ...
                                        <th class="px-3 py-2 border bg-blue-50 text-blue-800 font-semibold">DELIVERY DATE</th>
                                ...
                                <tbody>
                                    @forelse($details as $index => $item)
                                        ...
                                        @endphp
                                        <tr class="hover:bg-blue-50 dark:hover:bg-gray-700 cursor-pointer" onclick="showTData3('{{ $key }}', this)">
    ...
    <script>
        ...
        function hideAllDetails() {
            ...
            if (currentSelectedRow) {
                currentSelectedRow.classList.remove('bg-blue-100', 'dark:bg-gray-900');
            }
        ...
        function toggleAdditionalData(key, contentGenerator) {
            ...
            if (currentActiveKey === key) {
                ...
                container.innerHTML = `<div class="bg-gray-50 dark:bg-gray-900 p-4 rounded-lg shadow-inner">${contentGenerator()}</div>`;
            }
        }
